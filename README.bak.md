...
This tool targets Linux + ROS 2 workflow, and has been designed to accommodate various Intel RealSense RGB-D cameras. Use with other depth camera vendors remains untested. If used with other ROS distributions, cameras, or
RealSense firmware version, help out and report what worked!
...
- Receives two live ROS 2 `PointCloud2` messages and reads the corresponding TF transforms.
